...
<x-app-layout>
    ...
    <div class="flex">
        ...
        <div class="flex-1 p-6 bg-white">
            ...
            <form method="POST" action="{{ route('rev.updaterev', $review->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="title" name="title" class="w-full p-2 mt-2 border-gray rounded-lg" value="{{ old('title', $review->book->title) }}" disabled>
                </div>
